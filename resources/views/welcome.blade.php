		...
		<div class="max-w-7xl mx-auto px-4">
			...
			<div class="grid grid-cols-12 gap-4">
				<div class="col-span-12 md:col-span-4 bg-white px-5 py-7 rounded shadow">
					...
					<p>The transparent bars material is virtually unbreakable and withstands a tremendous amount of force. They are flexible and have a tensile breaking strength of 3000 kg.</p>
				</div>
				<div class="col-span-12 md:col-span-4 bg-white px-5 py-7 rounded shadow">
				...
				<div class="col-span-12 md:col-span-4 bg-white px-5 py-7 rounded shadow">
					...
					<p>With hundreds of homes fitted with our product, we’ve done almost all kinds of windows. View our photo gallery and see how the clear burglar bars will look on your style window.</p>
